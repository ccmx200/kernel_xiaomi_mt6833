...
/* ReSukiSU extended SUSFS commands */
#define CMD_SUSFS_ADD_SUS_PATH_LOOP 0x55563
#define CMD_SUSFS_HIDE_SUS_MNTS_FOR_NON_SU_PROCS 0x55564
#define CMD_SUSFS_SET_CMDLINE_OR_BOOTCONFIG 0x55565
#define CMD_SUSFS_ADD_OPEN_REDIRECT 0x55566
#define CMD_SUSFS_ADD_SUS_MAP 0x55567
#define CMD_SUSFS_ENABLE_AVC_LOG_SPOOFING 0x55568
#define CMD_SUSFS_SHOW_ENABLED_FEATURES 0x55569
#define CMD_SUSFS_SHOW_VARIANT 0x5556a
#define CMD_SUSFS_SHOW_VERSION 0x5556b

#define SUSFS_MAGIC 0x4d455300
...
/* ReSukiSU extended function declarations */
